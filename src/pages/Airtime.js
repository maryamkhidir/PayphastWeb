    ...
    <div style={{flex:1, marginTop:25}}>
        ...
        <div style={{display:'flex', flexWrap:'wrap', marginTop:20, marginLeft: -12, marginRight: -12}}>
          <div style={styles.form}>
            <div style={{color:'#656B71', fontSize:14, marginBottom:10}}>Your Phone number *</div>
          ...
          <div style={styles.form}>
            <div style={{color:'#656B71', fontSize:14, marginBottom:10}}>Amount (NGN)</div>
            <InputBase style={{border:"1px solid #C3CAD9", borderRadius:8, height:48, paddingLeft:15, paddingRight:15, color:'#212529', fontSize:16}}
              classes={{
                input:classes.inputStyle,
              }}
        ...
        <div onClick={() => history.push('/confirm-airtime')} style={{justifyContent:'center', marginTop:20, marginBottom:30, alignItems:'center', display:'flex', height:48, fontFamily: "Titillium", color: '#FFF', fontSize: 16, backgroundColor:'#5531EE', borderRadius:6, cursor:'pointer'}}>Buy Airtime</div>
    </div>
  )
}
            ...
            <div style={styles.content}>
              ...
              <section style={styles.section}>
                <div style={styles.transactions}>
                  <div style={{fontFamily:'Titillium', fontSize:24, marginBottom:4, color:'#212529'}}>Airtime Recharge</div>
