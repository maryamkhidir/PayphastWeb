    ...
    <div style={{flex:1, marginTop:25}}>
          ...
          <div style={{marginTop:10, marginBottom:30, display:'flex',  alignItems:'flex-start', justifyContent:'space-between'}}>
            <div style={{ display:'flex',  alignItems:'center'}}>
              <div style={{display:"flex", alignItems:'center', justifyContent:'center', height:55, width:55, borderRadius:10, border:'1px solid #EFF3F6'}}>
                <img src={Images.dstv} style={{width:33, height:33}} />
              </div>
              <div style={{marginLeft:20}}>
                <div style={{fontFamily:'Titillium', fontWeight:'bold', fontSize:16, marginBottom:8, color:'#242131'}}>DSTV Compact Plus</div>
                <div style={{fontFamily:'Titillium', color:'#81838C', fontSize:16}}>DSTV Nigeria</div>
              </div>
            </div>
            <div style={{fontFamily:'Titillium', fontWeight:'bold', fontSize:18, color:'#242131'}}>4972747682</div>
          </div>
        </div>
        <div style={{borderBottom: '1.37981px solid #EFF3F6'}} />
        <div>
        ...
        <div>
          <div style={{display:'flex', justifyContent:'space-between', margin:'25px auto 40px'}}>
            ...
            <div style={{fontFamily:'Titillium', fontWeight:'bold', fontSize:24, color:'#5531EE'}}>N18610.79</div>
          </div>
        </div>
        <div onClick={() => history.push('/success-cable')} style={{justifyContent:'center', marginTop:20, marginBottom:30, alignItems:'center', display:'flex', height:48, fontFamily: "Titillium", color: '#FFF', fontSize: 16, backgroundColor:'#5531EE', borderRadius:6, cursor:'pointer'}}>Confirm Payment</div>
    </div>
  )
}


export default class ConfirmCable extends Component {
  constructor(props) {
    super(props)
    this.state = {
      mobileOpen:false,
            ...
            <div style={styles.content}>
              ...
              <section style={styles.section}>
                <div style={styles.transactions}>
                  <div style={{fontFamily:'Titillium', fontSize:24, marginBottom:4, color:'#212529'}}>Confirm Cable TV Payment</div>
